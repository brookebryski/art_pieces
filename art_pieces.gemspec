...
require "art_pieces/version"

Gem::Specification.new do |spec|
  spec.name          = "art_pieces"
  spec.version       = ArtPieces::VERSION
  spec.authors       = ["'chic-state-0895'"]
  spec.email         = ["'brookeabryski@gmail.com'"]

  spec.summary       = %q{Short summary goes here.}
  spec.description   = %q{Longer description goes here or delete this line.}
